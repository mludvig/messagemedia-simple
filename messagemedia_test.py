...
def test_auth_with_content_set_date():
    ...
    assert response['Authorization'] == 'hmac username="API_KEY_12345678", algorithm="hmac-sha1", headers="Date x-Content-MD5 request-line", signature="4s+H5SQr4Ucc5dAHO/KdJ1RDj0k="'
